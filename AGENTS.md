...
This project is indexed by GitNexus as **RemEx** (34544 symbols, 77168 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
