...
This project is indexed by GitNexus as **RemEx** (10090 symbols, 19588 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
