...
This project is indexed by GitNexus as **RemEx** (6753 symbols, 13799 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
