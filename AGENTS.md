...
This project is indexed by GitNexus as **RemEx** (7049 symbols, 16881 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
