...
This project is indexed by GitNexus as **RemEx** (6930 symbols, 16628 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
