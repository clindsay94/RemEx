...
This project is indexed by GitNexus as **RemEx** (27555 symbols, 60892 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
