...
This project is indexed by GitNexus as **RemEx** (31048 symbols, 68815 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
