...
This project is indexed by GitNexus as **RemEx** (7814 symbols, 16356 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
