...
This project is indexed by GitNexus as **RemEx** (26013 symbols, 60004 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
