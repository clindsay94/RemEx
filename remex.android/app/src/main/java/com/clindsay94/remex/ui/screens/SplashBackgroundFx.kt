 ...
 * outline) at the hero's 108-unit transform, isolated so a caller can render its own hero art
 * underneath and cross-fade to this identical bolt.
 *
 * The CosmicZoom hero (Task 3) draws the terminal-window brand mark and cross-fades to this
 * strike. This is the single home for the bolt art — the legacy "R"-logo helper that shared
 * these draw lines was removed in Task 4. The tx/ty/scale math positions the bolt at the hero's
 * 108-unit transform, including impact shudder.
 */
