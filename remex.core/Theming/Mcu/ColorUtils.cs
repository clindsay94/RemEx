// Transcribed from material-components-android 1.14.0: lib/java/com/google/android/material/color/utilities/ColorUtils.java
/*
...
/// <summary>
/// Color science utilities. Utility methods for color science constants and color space conversions
...
public static class ColorUtils
{
    ...
    internal static readonly double[] WhitePointD65Values = new double[] { 95.047, 100.0, 108.883 };
    ...
    {
        return 0xFF000000u | (uint)((red & 255) << 16) | (uint)((green & 255) << 8) | (uint)(blue & 255);
    }
    ...
    {
        double[] whitePoint = WhitePointD65Values;
    ...
    /// <summary>
    /// Converts an L* value to a Y value. L* in L*a*b* and Y in XYZ measure the same quantity,
    /// luminance. L* measures perceptual luminance, a linear scale. Y in XYZ measures relative
    ...
    /// <summary>
    /// Converts a Y value to an L* value. L* in L*a*b* and Y in XYZ measure the same quantity,
    /// luminance. L* measures perceptual luminance, a linear scale. Y in XYZ measures relative
    /// luminance, a logarithmic scale.
    /// </summary>
    ...
    public static int Delinearized(double rgbComponent)
    {
        ...
        return MathUtils.ClampInt(0, 255, (int)(long)Math.Floor(delinearized * 255.0 + 0.5)); // Java: (int) Math.round(delinearized * 255.0)
    }
