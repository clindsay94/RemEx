// Transcribed from material-components-android 1.14.0: lib/java/com/google/android/material/color/utilities/HctSolver.java
/*
...
{
    internal static readonly double[][] ScaledDiscountFromLinrgb =
        new double[][]
        {
            new double[]
            {
    ...
    internal static readonly double[][] LinrgbFromScaledDiscount =
        new double[][]
        {
            new double[]
            {
    ...
    internal static readonly double[] YFromLinrgb = new double[] { 0.2126, 0.7152, 0.0722 };

    internal static readonly double[] CriticalPlanes =
        new double[]
        {
    ...
    /// <returns>The intersection point of the segment AB with the plane R=coordinate, G=coordinate, or B=coordinate</returns>
    ...
    internal static uint FindResultByJ(double hueRadians, double chroma, double y)
    {
