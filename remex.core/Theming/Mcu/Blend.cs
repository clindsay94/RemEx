// Transcribed from material-components-android 1.14.0: lib/java/com/google/android/material/color/utilities/Blend.java
/*
...
public static class Blend
{
    ...
    public static uint HctHue(uint from, uint to, double amount)
    {
        ...
        Hct blended = Hct.From(ucsCam.Hue, fromCam.Chroma, ColorUtils.LstarFromArgb(from));
