...
This project is indexed by GitNexus as **RemEx** (26985 symbols, 61873 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
