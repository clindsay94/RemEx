...
This project is indexed by GitNexus as **RemEx** (31040 symbols, 68734 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
