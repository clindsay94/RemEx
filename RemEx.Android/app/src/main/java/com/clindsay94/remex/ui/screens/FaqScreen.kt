...
private val faqItems = listOf(
    FaqItem(questionRes = R.string.faq_q1, answerRes = R.string.faq_a1, releasesLink = true),
...
fun FaqScreen() {
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(stringResource(R.string.screen_faq_title), fontWeight = FontWeight.Bold) }
            )
        }
    ) { padding ->
        Column(
